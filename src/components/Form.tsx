...
interface FormProps {
  ...
  register: (name: string, username: string, password: string, confirmPassword: string) => void;
  loading: boolean;
  errorMessage: string | null;
  isAuthenticated: boolean;
}

const Form: React.FC<FormProps> = ({ login, register, loading, errorMessage, isAuthenticated }) => {
